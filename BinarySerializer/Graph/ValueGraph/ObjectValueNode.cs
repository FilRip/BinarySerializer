...
internal class ObjectValueNode(ValueNode parent, string name, TypeNode typeNode) : ValueNode(parent, name, typeNode)
{
    ...
    public override object Value
    {
        ...
        set
        {
            ...
            _subTypeNode = localTypeNode.GetSubTypeNode(valueType);
    ...
    protected object GetValue(Func<ValueNode, object> childValueSelector)
    {
        ...
        if (node.ConstructorParameterNames.Length == 0)
        {
            ...
            nonparametricChildren = Children;
        }
        else
        {
            ...
            nonparametricChildren = Children.Except(parametricChildren);
        }
    ...
    private void ResolveValueType()
    {
        ...
        if (_valueType == null &&
            (localParent.ItemSubtypeBindings != null || localParent.ItemSubtypeFactoryBinding != null ||
             localParent.ItemSubtypeDefaultAttribute != null))
        {
            SetValueType(localParent.ItemSubtypeBindings, Parent, localParent.ItemSubtypeAttributes,
                localParent.ItemSubtypeFactoryBinding, localParent.ItemSubtypeFactory,
                localParent.ItemSubtypeDefaultAttribute);
        }
